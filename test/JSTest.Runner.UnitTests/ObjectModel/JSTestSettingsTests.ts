...
describe('JSTestSettings suite', () => {
    ...
    it('will throw for not found attachments folder', (done) => {
        ...
        const settings = new JSTestSettings(json);

        Assert.throws(() => settings.setupAttachments(json, {} as IEnvironment),
    ...
    it('will use temp path for attachments folder', () => {
        ...
        const settings = new JSTestSettings(json);
        settings.setupAttachments(json, { getTempDirectory: () => tmpDir } as IEnvironment);
