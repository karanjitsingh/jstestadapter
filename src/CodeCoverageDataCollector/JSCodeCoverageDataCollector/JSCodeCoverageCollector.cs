...
namespace Microsoft.TestPlatform.JSCodeCoverageDataCollector
{
    using System;
    ...
    [DataCollectorFriendlyName("JSCodeCoverage")]
    [DataCollectorTypeUri("datacollector://Microsoft/TestPlatform/Extensions/Blame/v1")]
    public class JSCodeCoverageCollector : DataCollector, ITestExecutionEnvironmentSpecifier
    {
        ...
        /// </summary>
        public JSCodeCoverageCollector()
        ...
        /// </param>
        internal JSCodeCoverageCollector(IBlameReaderWriter blameReaderWriter, IProcessDumpUtility processDumpUtility)
        {
