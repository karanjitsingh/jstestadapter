...
var KarmaReporter = function (baseReporterDecorator, config, emitter, logger, helper, formatError) {
    ...
    var discovery = false;
/*
	var INITIALIZE_REPORTER = function (callbacks) {
...
*/
    ...
    this.specSuccess = this.specSkipped = this.specFailure = function (browser, result) {
        EqtTrace.info(`KarmaReporter: specSuccess`);
...
KarmaReporter.$inject = ['baseReporterDecorator', 'config.jstestReporter', 'emitter', 'logger',
    'helper', 'formatError'];

// PUBLISH DI MODULE
module.exports = {
    'reporter:jstest': ['type', KarmaReporter]
};
